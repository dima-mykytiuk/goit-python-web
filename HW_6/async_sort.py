...
async def move_files(path, item_name, file_type, folder_name, base_path_to):
...
async def find_files_and_sort(path):
        ...
        if item_name not in folder_list and os.path.isfile(path_from) and item_name != '.DS_Store':
            ...
            for folder_name in folder_list:
                if folder_name != 'archives':
                    move = asyncio.create_task(move_files(path, item_name, file_type, folder_name, main_path))
                    await move
            ...
            await find_files_and_sort(path_from)
...
if __name__ == '__main__':
    ...
    asyncio.run(find_files_and_sort(str(_dir)))
